...
slug: SpringBoot-注解-Transactional
permalink: /post/SpringBoot-注解-Transactional.html
---
...
4. **结果处理**：
5. **Commit**：如果方法正常返回，代理对象执行事务提交。
6. **Rollback**：如果方法抛出特定异常，代理对象执行事务回滚。
7. **资源清理**：关闭数据库连接或将其归还连接池。
